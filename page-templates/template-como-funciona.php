...
<div class="container my-2">
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100 shadow">
                <div class="card-body">
                    ...
                    <p class="mt-2 text-success"><i class="fas fa-check-circle me-1"></i> <?php echo esc_html( get_theme_mod('como_step3_note', 'Tudo respeita as regras do seu plano e saldo.') ); ?></p>
    ...
    <div class="row mt-2">
        <div class="col-lg-12">
            <h2 class="mt-4"><i class="fas fa-server me-2"></i><?php echo esc_html( get_theme_mod('como_tech_title', __( 'Tecnologia e Escalabilidade', 'institucional-01' ) ) ); ?></h2>
